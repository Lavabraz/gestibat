...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={"unique_together": {("agent", "service")}},
        ),
        migrations.CreateModel(
            name="CustomUser",
            fields=[
                ...
                ("role", models.CharField(choices=[("super_admin", "super_admin"), ("admin", "admin"), ("editeur", "editeur"), ("lecteur", "lecteur")], default="lecteur", max_length=20)),
                ("agent", models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="user", to="users.agent")),
